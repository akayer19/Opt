...
optimizer = get_optimizer(Site.FANDUEL_SINGLE_GAME, Sport.BASKETBALL, solver=MIPSolver)

optimizer.load_players_from_csv(
    r"FD_Basketball/Single_Basketball.csv")
...
optimizer.export("FD_Basketball/result.csv")
